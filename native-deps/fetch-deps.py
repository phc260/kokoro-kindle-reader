...
to be kept pin-for-pin identical by hand; `fetch-deps.ps1` and `fetch-deps.sh` are now thin
harnesses that call this. Unifying them also settled a divergence they had already grown --
