...
# script assembles a self-contained source archive to attach beside each installer and link
# from the release body (section 6(d): equivalent access from the same place).
#
