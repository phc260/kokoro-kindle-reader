...
`rust-src` component and places its full `library/` tree in the release source archive.
...
SHA-256 manifests, and a rebuild README). A tag requires a clean matching source tag; a
